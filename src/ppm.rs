...
pub const BLACK: Color = Color::newi(0, 0, 0);
pub const WHITE: Color = Color::newi(255, 255, 255);
pub const RED: Color = Color::newi(255, 0, 0);
pub const GREEN: Color = Color::newi(0, 255, 0);
pub const BLUE: Color = Color::newi(0, 0, 255);
